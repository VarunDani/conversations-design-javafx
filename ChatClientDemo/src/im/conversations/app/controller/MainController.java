...
import im.conversations.app.datafx.AnimatedFlowContainer;
...
@FXMLController(value = "/resources/fxml/Main.fxml", title = "Conversations.im")
public class MainController {
	...
	public void init() throws FlowException, VetoException {
		...
		try {
			FXMLLoader loader = new FXMLLoader(getClass().getResource("/resources/fxml/MainPopup.fxml"));
		...
		Flow innerFlow = new Flow(ChatPanelController.class);
		...
		drawer.setSidePane(sideMenuFlowHandler.start(new AnimatedFlowContainer(Duration.millis(320), ContainerAnimations.SWIPE_RIGHT)));
