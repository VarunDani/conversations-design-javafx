...
public class ChatPanelController {
	...
	public void init() throws FlowException, VetoException {
		...
		items.add(new User("Varun Dani","/resources/img/user11.png","12:30","# Status of Varun Dani","available"));
		items.add(new User("User 2","/resources/img/user22.jpg","11:11","# status of second User","away"));
		items.add(new User("User 3","/resources/img/user33.jpg","10:11","# status of third User","busy"));
		
		sideList2.setItems(items);
		sideList2.setCellFactory((ListView<User> l) -> new UserListCell());
		
		messages.add(new Message("Varun Dani","/resources/img/user11.png","12:30","Hello !! How are you "));
		messages.add(new Message("User","/resources/img/user22.jpg","12:35","I am Fine Thak you .. "));
